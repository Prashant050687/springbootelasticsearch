...
- Build with tests<br/>
    On building the application with tests, the tests will add documents to the elastic search index. The tests also have an example to search the document from elastic search.
