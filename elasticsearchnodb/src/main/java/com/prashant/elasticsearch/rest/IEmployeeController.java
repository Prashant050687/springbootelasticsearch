    ...
    responses = {
      ...
      @ApiResponse(responseCode = "4xx", description = "Error retrieving Employee data",
        content = @Content(
          mediaType = "application/json",
          schema = @Schema(implementation = ErrorDetail.class)))})
  ResponseEntity<? extends EmployeeDTO> getEmployeeById(@PathVariable(name = "id") final String assetId);
    ...
    responses = {
      ...
      @ApiResponse(responseCode = "4xx", description = "Error retrieving Employee data",
        content = @Content(
          mediaType = "application/json",
          schema = @Schema(implementation = ErrorDetail.class)))})
  ResponseEntity<? extends EmployeeDTO> saveEmployee(@RequestBody final EmployeeDTO employee);
    ...
    responses = {
      ...
      @ApiResponse(responseCode = "4xx", description = "Error retrieving Employee data",
        content = @Content(
          mediaType = "application/json",
          schema = @Schema(implementation = ErrorDetail.class)))})
  HttpEntity<Void> deleteEmployeeById(@PathVariable(name = "id") final String id,
